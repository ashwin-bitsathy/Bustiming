...
export default class Bus extends Component {
  initialState = {
    users: [
      { name: 'Mettupalayam', username: 'Sirumugai' },
    ],
    results: [],
    query: '',
  }
  ...
  render() {
    ...
    return (
            ...
            <NAV/>
      <Container>
        <Add addRow={this.addRow} ></Add>
        <h1>search-bus-from </h1>
        <Input label="BusFrom" icon="search" onChange={this.search} placeholder="Search" ></Input>
        <View
          data={data}
